...
import android.graphics.Bitmap;
	...
	public class InteractiveMap implements PConstants {
	  ...
	  public int MAX_IMAGES_TO_KEEP = 16;
	  ...
	  public void draw() throws OutOfMemoryError, NullPointerException {
...
//            /****/
  ...
  public class TileLoader implements Runnable {
    ...
    public void run() throws OutOfMemoryError, NullPointerException {
      ...
      PImage img = null;
      do{
      //bmg = provider.getTile(urls[0]);
      try{
          img = new PImage(provider.getTile(urls[0]));
          //provider.getTileDBHelper().clearBitmap();
      } catch(NullPointerException e){
          System.out.println("InteractiveMap.java: 475: error creating PImage");
      }
      if(img==null) System.out.println("IntaractiveMap.java(473) null bitmap returned!! trying again..");
      }while(img==null);
      ...
      //}catch(Exception e){
          //img = null;
          //p.println("out of memory..please wait..");
      //}
      PImage img2;
      if (img != null) {
        for (int i = 1; i < urls.length; i++) {
          //PImage img2 = p.loadImage(urls[i], "unknown");
          img2 = new PImage(provider.getTile(urls[i]));
          img2.loadPixels();
          provider.getTileDBHelper().clearBitmap();
          if (img2 != null) {
            //img.loadPixels();
